 ...
 */
{
    ...
    class Slideshow {
        ...
        toggleContent(action) {
            ...
            times.slideFigures = action === 'show' ? 
                ...
                pos => Number(1 + pos*this.animationSettings.staggerFactor);
        ...
        toggleSlides(currentSlide, upcomingSlide) {
            ...
            upcomingSlideFigures.forEach((figure, pos) => {
                this.tl
                .to(figure.DOM.el, this.animationSettings.duration+1, { 
                    ease: this.animationSettings.ease,
                ...
                .to(figure.DOM.slideEl, this.animationSettings.duration+1, { 
                    ease: this.animationSettings.ease,
                    x: '0%'
                }, 'begin+=' + Number(this.animationSettings.staggerFactor*(currentSlide.figuresTotal-1) + pos*this.animationSettings.staggerFactor));
            });
    ...
    [...document.querySelectorAll('[data-play]')].forEach((link) => {
        link.addEventListener('mouseenter', () => cursor.enterPlay());
        link.addEventListener('mouseleave', () => cursor.leavePlay());
        link.addEventListener('click', () => cursor.click());
    });
